<?php
class B3it_XmlBind_Bmecat2005_FtSynonyms extends B3it_XmlBind_Bmecat2005_XmlBind
{
	...
	/**
	 * @param $value Synonym[]
	 * @return B3it_XmlBind_Bmecat2005_FtSynonyms extends B3it_XmlBind_Bmecat2005_XmlBind
	 */
	...
	public function toXml($xml){
		 $node = new DOMElement('FT_SYNONYMS');
