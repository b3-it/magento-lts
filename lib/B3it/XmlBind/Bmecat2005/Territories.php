<?php
class B3it_XmlBind_Bmecat2005_Territories extends B3it_XmlBind_Bmecat2005_XmlBind
{
	 ...
	 * @return B3it_XmlBind_Bmecat2005_Territories extends B3it_XmlBind_Bmecat2005_XmlBind
	 */
	...
	public function toXml($xml){
		 $node = new DOMElement('TERRITORIES');
