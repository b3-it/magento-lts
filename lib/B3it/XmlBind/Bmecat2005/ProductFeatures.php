<?php
class B3it_XmlBind_Bmecat2005_ProductFeatures extends B3it_XmlBind_Bmecat2005_XmlBind
{
	...
	/* @var GroupProductOrder */
	private $_GroupProductOrder = null;	
	 ...
	 * @return B3it_XmlBind_Bmecat2005_ProductFeatures extends B3it_XmlBind_Bmecat2005_XmlBind
	 */
	...
	/**
	 * @return B3it_XmlBind_Bmecat2005_GroupProductOrder
	 */
	public function getGroupProductOrder()
	{
		if($this->_GroupProductOrder == null)
		{
			$this->_GroupProductOrder = new B3it_XmlBind_Bmecat2005_GroupProductOrder();
		}
		
		return $this->_GroupProductOrder;
	}
	
	/**
	 * @param $value GroupProductOrder
	 * @return B3it_XmlBind_Bmecat2005_ProductFeatures extends B3it_XmlBind_Bmecat2005_XmlBind
	 */
	public function setGroupProductOrder($value)
	{
		$this->_GroupProductOrder = $value;
		return $this;
	}
	...
	public function toXml($xml){
		...
		if($this->_GroupProductOrder != null){
			$this->_GroupProductOrder->toXml($xml);
		}
