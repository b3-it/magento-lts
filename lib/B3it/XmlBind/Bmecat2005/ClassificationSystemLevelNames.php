<?php
class B3it_XmlBind_Bmecat2005_ClassificationSystemLevelNames extends B3it_XmlBind_Bmecat2005_XmlBind
{
	...
	/**
	 * @return B3it_XmlBind_Bmecat2005_ClassificationSystemLevelName[]
	 */
	...
	/**
	 * Create new B3it_XmlBind_Bmecat2005_ClassificationSystemLevelName and add it to list
	 * @return B3it_XmlBind_Bmecat2005_ClassificationSystemLevelName
	 */
	public function getClassificationSystemLevelName()
	{
		$res = new B3it_XmlBind_Bmecat2005_ClassificationSystemLevelName();
	 ...
	 * @return B3it_XmlBind_Bmecat2005_ClassificationSystemLevelNames extends B3it_XmlBind_Bmecat2005_XmlBind
	 */
