<?php
class B3it_XmlBind_Bmecat2005_FeatureContent extends B3it_XmlBind_Bmecat2005_XmlBind
{
	 ...
	 * @return B3it_XmlBind_Bmecat2005_FeatureContent extends B3it_XmlBind_Bmecat2005_XmlBind
	 */
	...
	/**
	 * @return B3it_XmlBind_Bmecat2005_FtFacets
	 */
	public function getFtFacets()
	{
		if($this->_FtFacets == null)
		{
			$this->_FtFacets = new B3it_XmlBind_Bmecat2005_FtFacets();
		}
	...
	/**
	 * @param $value FtFacets
	 * @return B3it_XmlBind_Bmecat2005_FeatureContent extends B3it_XmlBind_Bmecat2005_XmlBind
	 */
	public function setFtFacets($value)
	{
		$this->_FtFacets = $value;
		return $this;
	}
	...
	public function toXml($xml){
		 $node = new DOMElement('FEATURE_CONTENT');
