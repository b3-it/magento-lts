<?php
class B3it_XmlBind_Bmecat2005_ProductDimensions extends B3it_XmlBind_Bmecat2005_XmlBind
{
	...
	/**
	 * @param $value Volume
	 * @return B3it_XmlBind_Bmecat2005_ProductDimensions extends B3it_XmlBind_Bmecat2005_XmlBind
	 */
	...
	public function toXml($xml){
		 $node = new DOMElement('PRODUCT_DIMENSIONS');
