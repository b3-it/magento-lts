<?php
class B3it_XmlBind_Bmecat2005_ClassificationGroups extends B3it_XmlBind_Bmecat2005_XmlBind
{
	...
	/**
	 * @return B3it_XmlBind_Bmecat2005_ClassificationGroup[]
	 */
	...
	/**
	 * Create new B3it_XmlBind_Bmecat2005_ClassificationGroup and add it to list
	 * @return B3it_XmlBind_Bmecat2005_ClassificationGroup
	 */
	public function getClassificationGroup()
	{
		$res = new B3it_XmlBind_Bmecat2005_ClassificationGroup();
	 ...
	 * @return B3it_XmlBind_Bmecat2005_ClassificationGroups extends B3it_XmlBind_Bmecat2005_XmlBind
	 */
