<?php
class B3it_XmlBind_Bmecat2005_Typeftemplate extends B3it_XmlBind_Bmecat2005_XmlBind
{
	...
	/**
	 * @param $value FtId
	 * @return B3it_XmlBind_Bmecat2005_Typeftemplate extends B3it_XmlBind_Bmecat2005_XmlBind
	 */
