 ...
 * @name       	DispatchnotificationSummary
 * @author 		Holger Kögel <h.koegel@b3-it.de>
 * @copyright  	Copyright (c) 2016 B3 It Systeme GmbH - http://www.b3-it.de
 * @license		http://sid.sachsen.de OpenSource@SID.SACHSEN.DE
 */
class B3it_XmlBind_Opentrans21_DispatchnotificationSummary extends B3it_XmlBind_Opentrans21_XmlObject
{
	...
	{
		$node = new DOMElement('DISPATCHNOTIFICATION_SUMMARY');
