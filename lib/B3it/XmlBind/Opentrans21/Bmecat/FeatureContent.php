 ...
 * @name       	Bmecat_FeatureContent
 * @author 		Holger Kögel <h.koegel@b3-it.de>
 * @copyright  	Copyright (c) 2016 B3 It Systeme GmbH - http://www.b3-it.de
 * @license		http://sid.sachsen.de OpenSource@SID.SACHSEN.DE
 */
class B3it_XmlBind_Opentrans21_Bmecat_FeatureContent extends B3it_XmlBind_Opentrans21_XmlObject
{
	...
	/* @var B3it_XmlBind_Opentrans21_Bmecat_FtFacets */
	private $__FtFacets = null;
	 ...
	 */
	public function getFtFacets()
	{
		if($this->__FtFacets == null)
		{
			$this->__FtFacets = new B3it_XmlBind_Opentrans21_Bmecat_FtFacets();
		}
	
		return $this->__FtFacets;
	}
	
	/**
	 * @param $value B3it_XmlBind_Opentrans21_Bmecat_FtFacets
	 * @return B3it_XmlBind_Opentrans21_Bmecat_FeatureContent
	 */
	public function setFtFacets($value)
	{
		$this->__FtFacets = $value;
		return $this;
	}
	...
	if( $xml instanceof DOMDocument){
			$node = $xml->createElementNS('http://www.bmecat.org/bmecat/2005','bmecat:FEATURE_CONTENT');
		} else {
			$node = $xml->ownerDocument->createElementNS('http://www.bmecat.org/bmecat/2005','bmecat:FEATURE_CONTENT');
		}
