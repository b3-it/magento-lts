 ...
 * @name       	Bmecat_ProductPriceDetails
 * @author 		Holger Kögel <h.koegel@b3-it.de>
 * @copyright  	Copyright (c) 2016 B3 It Systeme GmbH - http://www.b3-it.de
 * @license		http://sid.sachsen.de OpenSource@SID.SACHSEN.DE
 */
class B3it_XmlBind_Opentrans21_Bmecat_ProductPriceDetails extends B3it_XmlBind_Opentrans21_XmlObject
{
	...
	/* @var B3it_XmlBind_Opentrans21_ProductPriceDetails_Bmecat_Datetime */
	...
	/**
	 * Create new B3it_XmlBind_Opentrans21_ProductPriceDetails_Bmecat_Datetime and add it to list
	 * @return B3it_XmlBind_Opentrans21_ProductPriceDetails_Bmecat_Datetime
	 */
	public function getDatetime()
	{
		$res = new B3it_XmlBind_Opentrans21_ProductPriceDetails_Bmecat_Datetime();
	...
	/**
	 * @param $value B3it_XmlBind_Opentrans21_ProductPriceDetails_Bmecat_Datetime
	 * @return B3it_XmlBind_Opentrans21_Bmecat_ProductPriceDetails
	 */
	...
	if( $xml instanceof DOMDocument){
			$node = $xml->createElementNS('http://www.bmecat.org/bmecat/2005','bmecat:PRODUCT_PRICE_DETAILS');
		} else {
			$node = $xml->ownerDocument->createElementNS('http://www.bmecat.org/bmecat/2005','bmecat:PRODUCT_PRICE_DETAILS');
		}
