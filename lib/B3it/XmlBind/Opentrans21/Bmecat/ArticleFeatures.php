 ...
 * @name       	Bmecat_ArticleFeatures
 * @author 		Holger Kögel <h.koegel@b3-it.de>
 * @copyright  	Copyright (c) 2016 B3 It Systeme GmbH - http://www.b3-it.de
 * @license		http://sid.sachsen.de OpenSource@SID.SACHSEN.DE
 */
class B3it_XmlBind_Opentrans21_Bmecat_ArticleFeatures extends B3it_XmlBind_Opentrans21_XmlObject
{
	...
	/* @var B3it_XmlBind_Opentrans21_Bmecat_ClassificationGroupArticleorder */
	private $__ClassificationGroupArticleorder = null;

	
	/* @var B3it_XmlBind_Opentrans21_Bmecat_Feature */
	...
	/**
	 * @return B3it_XmlBind_Opentrans21_Bmecat_ClassificationGroupArticleorder
	 */
	public function getClassificationGroupArticleorder()
	{
		if($this->__ClassificationGroupArticleorder == null)
		{
			$this->__ClassificationGroupArticleorder = new B3it_XmlBind_Opentrans21_Bmecat_ClassificationGroupArticleorder();
		}
	
		return $this->__ClassificationGroupArticleorder;
	}
	
	/**
	 * @param $value B3it_XmlBind_Opentrans21_Bmecat_ClassificationGroupArticleorder
	 * @return B3it_XmlBind_Opentrans21_Bmecat_ArticleFeatures
	 */
	public function setClassificationGroupArticleorder($value)
	{
		$this->__ClassificationGroupArticleorder = $value;
		return $this;
	}
	

	/**
	 * Create new B3it_XmlBind_Opentrans21_Bmecat_Feature and add it to list
	 * @return B3it_XmlBind_Opentrans21_Bmecat_Feature
	 */
	public function getFeature()
	{
		$res = new B3it_XmlBind_Opentrans21_Bmecat_Feature();
		$this->__FeatureA[] = $res;
	...
	/**
	 * @param $value B3it_XmlBind_Opentrans21_Bmecat_Feature
	 * @return B3it_XmlBind_Opentrans21_Bmecat_ArticleFeatures
	 */
	...
	if( $xml instanceof DOMDocument){
			$node = $xml->createElementNS('http://www.bmecat.org/bmecat/2005','bmecat:ARTICLE_FEATURES');
		} else {
			$node = $xml->ownerDocument->createElementNS('http://www.bmecat.org/bmecat/2005','bmecat:ARTICLE_FEATURES');
		}
		...
		if($this->__ClassificationGroupArticleorder != null){
			$this->__ClassificationGroupArticleorder->toXml($xml);
		}
