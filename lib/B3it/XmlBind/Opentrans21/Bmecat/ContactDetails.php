 ...
 * @name       	Bmecat_ContactDetails
 * @author 		Holger Kögel <h.koegel@b3-it.de>
 * @copyright  	Copyright (c) 2016 B3 It Systeme GmbH - http://www.b3-it.de
 * @license		http://sid.sachsen.de OpenSource@SID.SACHSEN.DE
 */
class B3it_XmlBind_Opentrans21_Bmecat_ContactDetails extends B3it_XmlBind_Opentrans21_XmlObject
{
	...
	/* @var B3it_XmlBind_Opentrans21_Bmecat_ContactRole */
	...
	/**
	 * Create new B3it_XmlBind_Opentrans21_Bmecat_ContactRole and add it to list
	 * @return B3it_XmlBind_Opentrans21_Bmecat_ContactRole
	 */
	public function getContactRole()
	{
		$res = new B3it_XmlBind_Opentrans21_Bmecat_ContactRole();
	...
	/**
	 * @param $value B3it_XmlBind_Opentrans21_Bmecat_ContactRole
	 * @return B3it_XmlBind_Opentrans21_Bmecat_ContactDetails
	 */
	...
	if( $xml instanceof DOMDocument){
			$node = $xml->createElementNS('http://www.bmecat.org/bmecat/2005','bmecat:CONTACT_DETAILS');
		} else {
			$node = $xml->ownerDocument->createElementNS('http://www.bmecat.org/bmecat/2005','bmecat:CONTACT_DETAILS');
		}
