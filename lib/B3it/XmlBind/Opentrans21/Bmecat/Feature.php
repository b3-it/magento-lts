 ...
 */
class B3it_XmlBind_Opentrans21_Bmecat_Feature extends B3it_XmlBind_Opentrans21_XmlObject
{
	...
	/* @var B3it_XmlBind_Opentrans21_Bmecat_Variants */
	private $__Variants = null;
	...
	public function getVariants()
	{
		...
		{
			$this->__Variants = new B3it_XmlBind_Opentrans21_Bmecat_Variants();
		}
	...
	/**
	 * @param $value B3it_XmlBind_Opentrans21_Bmecat_Variants
	 * @return B3it_XmlBind_Opentrans21_Bmecat_Feature
	 */
	public function setVariants($value)
	{
		$this->__Variants = $value;
		return $this;
	}
	...
	if( $xml instanceof DOMDocument){
			$node = $xml->createElementNS('http://www.bmecat.org/bmecat/2005','bmecat:FEATURE');
		} else {
			$node = $xml->ownerDocument->createElementNS('http://www.bmecat.org/bmecat/2005','bmecat:FEATURE');
		}
