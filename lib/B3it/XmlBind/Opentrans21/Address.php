 ...
 */
class B3it_XmlBind_Opentrans21_Address extends B3it_XmlBind_Opentrans21_XmlObject
{
	...
	/* @var B3it_XmlBind_Opentrans21_ContactDetails */
	...
	/* @var B3it_XmlBind_Opentrans21_TaxNumber */
	private $__TaxNumber = null;
	...
	/**
	 * Create new B3it_XmlBind_Opentrans21_ContactDetails and add it to list
	 * @return B3it_XmlBind_Opentrans21_ContactDetails
	 */
	public function getContactDetails()
	{
		$res = new B3it_XmlBind_Opentrans21_ContactDetails();
	...
	/**
	 * @param $value B3it_XmlBind_Opentrans21_ContactDetails
	 * @return B3it_XmlBind_Opentrans21_Address
	 */
	...
	/**
	 * @return B3it_XmlBind_Opentrans21_TaxNumber
	 */
	public function getTaxNumber()
	{
		if($this->__TaxNumber == null)
		{
			$this->__TaxNumber = new B3it_XmlBind_Opentrans21_TaxNumber();
		}
	
		return $this->__TaxNumber;
	}
	
	/**
	 * @param $value B3it_XmlBind_Opentrans21_TaxNumber
	 * @return B3it_XmlBind_Opentrans21_Address
	 */
	public function setTaxNumber($value)
	{
		$this->__TaxNumber = $value;
		return $this;
	}
