 ...
 */
class B3it_XmlBind_Opentrans21_InvoiceInfo extends B3it_XmlBind_Opentrans21_XmlObject
{
	...
	/* @var B3it_XmlBind_Opentrans21_InvoiceType */
	private $__InvoiceType = null;

	/* @var B3it_XmlBind_Opentrans21_InvoiceCoverage */
	private $__InvoiceCoverage = null;
	...
	/**
	 * @return B3it_XmlBind_Opentrans21_InvoiceType
	 */
	public function getInvoiceType()
	{
		if($this->__InvoiceType == null)
		{
			$this->__InvoiceType = new B3it_XmlBind_Opentrans21_InvoiceType();
		}
	...
	/**
	 * @param $value B3it_XmlBind_Opentrans21_InvoiceType
	 * @return B3it_XmlBind_Opentrans21_InvoiceInfo
	 */
	public function setInvoiceType($value)
	{
		$this->__InvoiceType = $value;
		return $this;
	}
	
	/**
	 * @return B3it_XmlBind_Opentrans21_InvoiceCoverage
	 */
	public function getInvoiceCoverage()
	{
		if($this->__InvoiceCoverage == null)
		{
			$this->__InvoiceCoverage = new B3it_XmlBind_Opentrans21_InvoiceCoverage();
		}
	
		return $this->__InvoiceCoverage;
	}
	
	/**
	 * @param $value B3it_XmlBind_Opentrans21_InvoiceCoverage
	 * @return B3it_XmlBind_Opentrans21_InvoiceInfo
	 */
	public function setInvoiceCoverage($value)
	{
		$this->__InvoiceCoverage = $value;
		return $this;
	}
	...
	{
		$node = new DOMElement('INVOICE_INFO');
		...
		if($this->__InvoiceType != null){
			$this->__InvoiceType->toXml($xml);
		}
		if($this->__InvoiceCoverage != null){
			$this->__InvoiceCoverage->toXml($xml);
		}
		if($this->__DeliverynoteId != null){
