<?php
class B3it_XmlBind_Bmecat12_ClassificationSystemFeatureTemplates extends B3it_XmlBind_Bmecat12_XmlBind
{
	...
	/**
	 * @return B3it_XmlBind_Bmecat12_ClassificationSystemFeatureTemplate[]
	 */
	...
	/**
	 * Create new B3it_XmlBind_Bmecat12_ClassificationSystemFeatureTemplate and add it to list
	 * @return B3it_XmlBind_Bmecat12_ClassificationSystemFeatureTemplate
	 */
	public function getClassificationSystemFeatureTemplate()
	{
		$res = new B3it_XmlBind_Bmecat12_ClassificationSystemFeatureTemplate();
	 ...
	 * @return B3it_XmlBind_Bmecat12_ClassificationSystemFeatureTemplates extends B3it_XmlBind_Bmecat12_XmlBind
	 */
