<?php
class B3it_XmlBind_Bmecat12_ClassificationGroupFeatureTemplates extends B3it_XmlBind_Bmecat12_XmlBind
{
	...
	/**
	 * @return B3it_XmlBind_Bmecat12_ClassificationGroupFeatureTemplate[]
	 */
	...
	/**
	 * Create new B3it_XmlBind_Bmecat12_ClassificationGroupFeatureTemplate and add it to list
	 * @return B3it_XmlBind_Bmecat12_ClassificationGroupFeatureTemplate
	 */
	public function getClassificationGroupFeatureTemplate()
	{
		$res = new B3it_XmlBind_Bmecat12_ClassificationGroupFeatureTemplate();
	 ...
	 * @return B3it_XmlBind_Bmecat12_ClassificationGroupFeatureTemplates extends B3it_XmlBind_Bmecat12_XmlBind
	 */
