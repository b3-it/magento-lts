<?php
class B3it_XmlBind_Bmecat12_ArticleToCataloggroupMap extends B3it_XmlBind_Bmecat12_XmlBind
{
	...
	/**
	 * @return B3it_XmlBind_Bmecat12_ArtId
	 */
	public function getArtId()
	{
		if($this->_ArtId == null)
		{
			$this->_ArtId = new B3it_XmlBind_Bmecat12_ArtId();
		}
	...
	/**
	 * @param $value ArtId
	 * @return B3it_XmlBind_Bmecat12_ArticleToCataloggroupMap extends B3it_XmlBind_Bmecat12_XmlBind
	 */
	...
	/**
	 * @return B3it_XmlBind_Bmecat12_CatalogGroupId
	 */
	public function getCatalogGroupId()
	{
		if($this->_CatalogGroupId == null)
		{
			$this->_CatalogGroupId = new B3it_XmlBind_Bmecat12_CatalogGroupId();
		}
	...
	/**
	 * @return B3it_XmlBind_Bmecat12_ArticleToCataloggroupMapOrder
	 */
	public function getArticleToCataloggroupMapOrder()
	{
		if($this->_ArticleToCataloggroupMapOrder == null)
		{
			$this->_ArticleToCataloggroupMapOrder = new B3it_XmlBind_Bmecat12_ArticleToCataloggroupMapOrder();
		}
