<?php
class B3it_XmlBind_Bmecat12_FtAllowedValues extends B3it_XmlBind_Bmecat12_XmlBind
{
	...
	/**
	 * @return B3it_XmlBind_Bmecat12_AllowedValueIdref[]
	 */
	...
	/**
	 * Create new B3it_XmlBind_Bmecat12_AllowedValueIdref and add it to list
	 * @return B3it_XmlBind_Bmecat12_AllowedValueIdref
	 */
	public function getAllowedValueIdref()
	{
		$res = new B3it_XmlBind_Bmecat12_AllowedValueIdref();
	 ...
	 * @return B3it_XmlBind_Bmecat12_FtAllowedValues extends B3it_XmlBind_Bmecat12_XmlBind
	 */
