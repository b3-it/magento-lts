...
function rwt2(pos) {
	if (wptxt[0] == pos) {
	  var site_32009 = 'http://eur-lex.europa.eu/Result.do?RechType=RECH_celex&code=32009R0924&checktexts=checkbox';
	  var site_32012 = 'http://eur-lex.europa.eu/Result.do?RechType=RECH_celex&code=32012R0260&checktexts=checkbox';

	  //special web page text
		document.write(" <a href='" + site_32009 + "' target='_blank' title='Regulation 924 on eur-lex.europa.eu'>EU Regulation 924/2009</a>;" +
		               " <a href='" + site_32012 + "' target='_blank' title='Regulation 260 on eur-lex.europa.eu'>EU Regulation 260/2012 </a>");
	}
}
