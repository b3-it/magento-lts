ComponentPartsBundle = function(elementId,name) {
        ...
        this.addRow = function()
        {
			...
			data.transport_product_label = $j('#table-'+this.elementId+'-select-product option:selected').text();
			data.transport_product_id = $j('#table-'+this.elementId+'-select-product option:selected').val();
        	this.appendRow(data);
        }
