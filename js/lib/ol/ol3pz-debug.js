...
goog.require('olpz.control.PanZoom');
goog.require('olpz.control.ZoomSlider');


goog.exportSymbol(
    'olpz.control.PanZoom',
    olpz.control.PanZoom,
    OL3PANZOOM);

goog.exportProperty(
    olpz.control.PanZoom.prototype,
    'setMap',
    olpz.control.PanZoom.prototype.setMap);

goog.exportSymbol(
    'olpz.control.ZoomSlider',
    olpz.control.ZoomSlider,
    OL3PANZOOM);

goog.exportProperty(
    olpz.control.ZoomSlider.prototype,
    'getElement',
    olpz.control.ZoomSlider.prototype.getElement);
