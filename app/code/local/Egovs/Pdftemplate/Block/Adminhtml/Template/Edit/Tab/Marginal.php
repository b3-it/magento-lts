 ...
 */
class Egovs_Pdftemplate_Block_Adminhtml_Template_Edit_Tab_Marginal extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
      $form = new Varien_Data_Form();
      $this->setForm($form);
      $fieldset = $form->addFieldset('template_marginal', array('legend'=>Mage::helper('pdftemplate')->__('Marginal')));
     
     $fieldset->addField('marginal_pdftemplate_section_id', 'hidden', array(
          'name'      => 'marginal[pdftemplate_section_id]',
      ));
      
     $fieldset->addField('marginal_top', 'text', array(
      ...
      $fieldset->addField('marginal_left', 'text', array(
      ...
      $fieldset->addField('marginal_width', 'text', array(
      ...
      $fieldset->addField('marginal_height', 'text', array(
          'label'     => Mage::helper('pdftemplate')->__('Height'),
          'class'     => 'required-entry',
          'required'  => true,
          'name'      => 'marginal[height]',
      	  'value'     => '0',
      ));
      
      $fieldset->addField('marginal_occurrence', 'select', array(
          'label'     => Mage::helper('pdftemplate')->__('Occurrence'),
          'name'      => 'marginal[occurrence]',
      	  'values'    => Egovs_Pdftemplate_Model_Occurrence::getOptionArray(),
      ));
      
      
      $fieldset->addField('marginal_content', 'editor', array(
          'label'     => Mage::helper('pdftemplate')->__('Content'),
      	  'style'     => 'width:725px;height:460px',
          //'class'     => 'required-entry',
          //'required'  => true,
          'name'      => 'marginal[content]',
        ));
