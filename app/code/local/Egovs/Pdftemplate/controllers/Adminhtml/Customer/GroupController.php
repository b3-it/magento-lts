 ...
 */
class Egovs_Pdftemplate_Adminhtml_Customer_GroupController extends Mage_Adminhtml_Controller_Action
{
        ...
        if ($taxClass = $this->getRequest()->getParam('tax_class')) {
            try {
                ...
                if ($this->getRequest()->getParam('back')) {
                	$this->getResponse()->setRedirect($this->getUrl('*/*/edit', array('id' => $customerGroup->getId())));
                	return;
                }
