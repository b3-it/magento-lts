...
class Egovs_Extstock_Model_Salesorder extends Mage_Core_Model_Abstract
{
    ...
    protected function _construct() {
        ...
        //Sollte damit auf Egovs_Extstock_Model_Mysql4_SalesOrder zeigen
     ...
     * 
     * @return Egovs_Extstock_Model_SalesOrder
     */
	...
	protected function _backToStock($salesOrderItem, $backToStock = 0) {
		...
		if (!($collection instanceof Egovs_Extstock_Model_Mysql4_SalesOrder_Collection)) {
			Mage::throwException("extstock::Wrong type of collection. 'Egovs_Extstock_Model_Mysql4_SalesOrder_Collection' expected!");
		}
