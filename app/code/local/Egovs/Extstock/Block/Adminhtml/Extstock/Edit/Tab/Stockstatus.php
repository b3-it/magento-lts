...
class Egovs_Extstock_Block_Adminhtml_Extstock_Edit_Tab_Stockstatus extends Mage_Adminhtml_Block_Widget_Form
{
	protected function _prepareForm()
	{
		...
		if($canStatus && Mage::registry('extstock_data')->getOrigData('status') != Egovs_Extstock_Helper_Data::ORDERED)
		{
