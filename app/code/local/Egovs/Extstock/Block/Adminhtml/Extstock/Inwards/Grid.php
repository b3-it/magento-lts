 ...
 */
class Egovs_Extstock_Block_Adminhtml_Extstock_Inwards_Grid extends Egovs_Extreport_Block_Adminhtml_AbstractReportGrid
{
	/**
     * Sub report size
     *
    ...
    protected $_baseActionName = 'inwards';
