<?php
class Egovs_Extstock_Block_Adminhtml_Extstock_Overview extends Mage_Adminhtml_Block_Widget_Form
{
...
//		print($select->assemble());
		...
		Mage::dispatchEvent('extstock_overview_fetch_before', array('select' => $select));
