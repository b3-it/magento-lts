<?php
class Egovs_Search_Helper_Colognephon extends Mage_Core_Helper_Abstract
{
 
/**
 * A function for retrieving the K̦lner Phonetik value of a string
 *
 * As described at http://de.wikipedia.org/wiki/K̦lner_Phonetik
 * Based on Hans Joachim Postel: Die K̦lner Phonetik.
...
#echo cologne_phon('Sachsen'); 
#echo cologne_phon('Saxen'); 

function germanphonetic($word) {

    /**
    * @param  string  $word string to be analyzed
    * @return string  $value represents the K̦lner Phonetik value
    * @access public
    */
