 ...
 */
class Egovs_Isolation_Model_Entity_Attribute_Source_Storeviews extends Mage_Eav_Model_Entity_Attribute_Source_Abstract
{
    /**
    ...
    public function getAllOptions()
    {
        ...
        if (is_null($this->_options)) 
        {
        	...
        	$storeGroups = $helper->getUserStoreViews();
        	$this->_options = array();
