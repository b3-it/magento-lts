...
class Egovs_ProductFile_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    public function fileExists($name) {
        $path = Mage::getBaseDir('media') . DS . $this->getProductFileUploadDirectory() . DS . $name;
    ...
    public function getFileUrl($name) {
        return Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_MEDIA).$this->getProductFileUploadDirectory()."/".$name;
    }
