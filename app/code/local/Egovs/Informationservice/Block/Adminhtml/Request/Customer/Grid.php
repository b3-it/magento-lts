 ...
 */
class Egovs_Informationservice_Block_Adminhtml_Request_Customer_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        return  $this->getUrl('*/*/edit', array('customer'=>$row->getId()));
    }
