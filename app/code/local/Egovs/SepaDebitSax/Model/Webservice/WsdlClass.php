<?php
/**
 * File for Egovs_SepaDebitSax_Model_Webservice_WsdlClass to communicate with SOAP service
 * @package SepaMv
 * @date 2014-03-12
 ...
 */
/**
 * Egovs_SepaDebitSax_Model_Webservice_WsdlClass to communicate with SOAP service
 * Documentation : Interface fuer MandatsverwaltungWS
 * @package SepaMv
 * @date 2014-03-12
 * @author Frank Rochlitzer <f.rochlitzer@b3-it.de>
 * @version 0.9.0.0
 */
class Egovs_SepaDebitSax_Model_Webservice_WsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'https://sepatest.egov.sachsen.de/mandatsverwaltung/webservices/mandatsverwaltungWS?wsdl';
    /**
     ...
     * @var array
     */
    private $__internArrayToIterate;
    /**
     * Bool that tells if array is set or not
     * @var bool
     */
    private $__internArrayToIterateIsArray;
    /**
     * Items index browser
     * @var int
     */
    private $__internArrayToIterateOffset;
    
    protected static $_clientCert;
    protected static $_caCert;
    
    /**
     * Constructor
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::setLastError()
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::initSoapClient()
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::initInternArrayToIterate()
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::_set()
     ...
     * @return Egovs_SepaDebitSax_Model_Webservice_WsdlClass
     */
    ...
    public function getSoapClient()
    {
    	if (version_compare(phpversion(), '5.3', '<')===true) {
    		 $this->__soapClient = false;
    	}
    	
    	if(!$this->__soapClient)
    	{
    		 $this->initSoapClient( array());
    	}
     ...
     * @return SoapClient
     */
    protected function setSoapClient($_soapClient)
    {
        return ( $this->__soapClient = $_soapClient);
    }
    /**
     * Method initiating SoapClient
     * @uses SepaMvClassMap::classMap()
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::getDefaultWsdlOptions()
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::getSoapClientClassName()
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('Egovs_SepaDebitSax_Model_Webservice_ClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = Egovs_SepaDebitSax_Model_Webservice_ClassMap::classMap();
            $wsdlOptions['stream_context'] = $this->_getStreamContext();
     ...
     * If a class is named as {SepaMv}SoapClient, then this is the class that will be used.
    ...
    {
    	return 'Egovs_SepaDebitSax_Model_Webservice_Soap_Client';
    	
        if(class_exists('Egovs_SepaDebitSax_Model_Webservice_Soap_Client') && is_subclass_of('Egovs_SepaDebitSax_Model_Webservice_Soap_Client','SoapClient'))
            return 'Egovs_SepaDebitSax_Model_Webservice_Soap_Client';
        else
            return 'SoapClient';
    }
     ...
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::WSDL_CACHE_WSDL
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::WSDL_COMPRESSION
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::WSDL_ENCODING
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::WSDL_EXCEPTIONS
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::WSDL_FEATURES
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::WSDL_LOGIN
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::WSDL_PASSWORD
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::WSDL_SOAP_VERSION
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::WSDL_STREAM_CONTEXT
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::WSDL_TRACE
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::WSDL_TYPEMAP
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::WSDL_URL
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::VALUE_WSDL_URL
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::WSDL_USER_AGENT
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::WSDL_PROXY_HOST
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::WSDL_PROXY_PORT
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::WSDL_PROXY_LOGIN
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::WSDL_PROXY_PASSWORD
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::WSDL_LOCAL_CERT
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::WSDL_PASSPHRASE
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::WSDL_AUTHENTICATION
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::WSDL_SSL_METHOD
    ...
    {
        return array(
                    self::WSDL_CACHE_WSDL=>WSDL_CACHE_MEMORY,
                    ...
                    self::WSDL_STREAM_CONTEXT=>self::_getStreamContext(),
                    ...
                    self::WSDL_LOCAL_CERT=>self::_getClientCertificate(),
     ...
     * @return string
     */
    protected static function _getClientCertificate() {
    	if (self::$_clientCert == null) {
    		self::$_clientCert = Mage::getStoreConfig('payment_services/sepadebitsax/client_certificate');
    		if (empty(self::$_clientCert)) {
    			throw new Zend_Soap_Client_Exception(Mage::helper('sepadebitsax')->__('No client certificate for mandate management server specified!'));
    		}
    		self::$_clientCert = Mage::getBaseDir().self::$_clientCert;
    	}
     ...
     * @return string
     */
    protected static function _getCaCertificate() {
    	if (self::$_caCert == null) {
    		self::$_caCert = Mage::getStoreConfig('payment_services/sepadebitsax/ca_certificate');
    		if (empty(self::$_caCert)) {
    			throw new Zend_Soap_Client_Exception(Mage::helper('sepadebitsax')->__('No CA certifacte for mandate management server specified!'));
    		}
    		self::$_caCert = Mage::getBaseDir().self::$_caCert;
    	}
     ...
     * @return resource
     */
    protected static function _getStreamContext() {
    	return stream_context_create(
    			array(
    					'ssl' => array(
    							'verify_peer' => true,
    							'cafile' => self::_getCaCertificate(),
    							'local_cert' => self::_getClientCertificate()
    					)
    			)
    	);
    }
     ...
     */
    protected static function _getLocationFromConfig() {
    	//FIXME :: unqualified Elements in WSDL needed!!!!
    	//return Mage::getBaseDir().'/lib/ePayment/SepaSachsenmandatsverwaltungWS.xml';
    	$location = Mage::getStoreConfig('payment_services/sepadebitsax/service');
    	if (strripos($location, '?wsdl') < (strlen($location) - strlen('?wsdl'))) {
    		$location .= '?wsdl';
    	}
     ...
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::getSoapClient()
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::getFormatedXml()
     ...
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::getSoapClient()
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::convertStringHeadersToArray()
     ...
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::count()
     * @return int
     */
     ...
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::getInternArrayToIterate()
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::offsetGet()
     * @return mixed
     */
    public function current()
    {
        return $this->offsetGet($this->__internArrayToIterateOffset);
    }
    /**
     * Method moving the current position to the next element
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::getInternArrayToIterateOffset()
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::getInternArrayToIterateOffset()
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see Egovs_SepaDebitSax_Model_Webservice_WsdlClass::offsetGet()
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::getAttributeName()
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::__toString()
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::_set()
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::_get()
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::setInternArrayToIterate()
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::setInternArrayToIterateIsArray()
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::item()
     * @return mixed
     */
     ...
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::item()
     * @uses Egovs_SepaDebitSax_Model_Webservice_WsdlClass::length()
     * @return mixed
     */
    ...
    {
        return $this->offsetExists($_offset)?$this->__internArrayToIterate[$_offset]:null;
    }
    /**
    ...
    {
        return ($this->__lastError = $_lastError);
    }
    /**
    ...
    {
        return ($this->__lastError[$_methoName] = $_soapFault);
    }
    /**
    ...
    {
        return (is_array($this->__lastError) && array_key_exists($_methoName,$this->__lastError))?$this->__lastError[$_methoName]:null;
    }
    /**
    ...
    {
        return $this->__internArrayToIterate;
    }
    /**
    ...
    {
        return ($this->__internArrayToIterate = $_internArrayToIterate);
    }
    /**
    ...
    {
        return $this->__internArrayToIterateOffset;
    }
    /**
    ...
    {
        return ($this->__internArrayToIterateOffset = $_internArrayToIterateOffset);
    }
    /**
    ...
    {
        return $this->__internArrayToIterateIsArray;
    }
    /**
    ...
    {
        return ($this->__internArrayToIterateIsArray = $_internArrayToIterateIsArray);
    }
    /**
