<?php
/**
 * File for class Egovs_SepaDebitSax_Model_Webservice_Types_Result_SetzeLetzteNutzungSEPADebitorenMandatResult
 * @package SepaMv
 * @subpackage Structs
 * @date 2014-03-12
 ...
 */
/**
 * This class stands for Egovs_SepaDebitSax_Model_Webservice_Types_Result_SetzeLetzteNutzungSEPADebitorenMandatResult originally named SetzeLetzteNutzungSEPADebitorenMandatResult
 ...
 * @version 0.9.0.0
 */
class Egovs_SepaDebitSax_Model_Webservice_Types_Result_SetzeLetzteNutzungSEPADebitorenMandatResult extends Egovs_SepaDebitSax_Model_Webservice_WsdlClass
{
    /**
     * The Result
    ...
    public $Mandat;
    /**
     * Constructor method for SetzeLetzteNutzungSEPADebitorenMandatResult
