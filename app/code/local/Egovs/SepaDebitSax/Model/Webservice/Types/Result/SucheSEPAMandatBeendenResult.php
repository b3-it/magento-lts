<?php
/**
 * File for class Egovs_SepaDebitSax_Model_Webservice_Types_Result_SucheSEPAMandatBeendenResult
 * @package SepaMv
 * @subpackage Structs
 * @date 2014-03-12
 ...
 */
/**
 * This class stands for Egovs_SepaDebitSax_Model_Webservice_Types_Result_SucheSEPAMandatBeendenResult originally named SucheSEPAMandatBeendenResult
 ...
 * @version 0.9.0.0
 */
class Egovs_SepaDebitSax_Model_Webservice_Types_Result_SucheSEPAMandatBeendenResult extends Egovs_SepaDebitSax_Model_Webservice_WsdlClass
{
    /**
     * The Result
    ...
    public $Result;
    /**
     * Constructor method for SucheSEPAMandatBeendenResult
