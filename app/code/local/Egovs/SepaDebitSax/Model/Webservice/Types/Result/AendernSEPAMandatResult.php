<?php
/**
 * File for class Egovs_SepaDebitSax_Model_Webservice_Types_Result_AendernSEPAMandatResult
 * @package SepaMv
 * @subpackage Structs
 * @date 2014-03-12
 ...
 */
/**
 * This class stands for Egovs_SepaDebitSax_Model_Webservice_Types_Result_AendernSEPAMandatResult originally named AendernSEPAMandatResult
 ...
 * @version 0.9.0.0
 */
class Egovs_SepaDebitSax_Model_Webservice_Types_Result_AendernSEPAMandatResult extends Egovs_SepaDebitSax_Model_Webservice_WsdlClass
{
    /**
     * The Result
    ...
    public $Mandat;
    /**
     * Constructor method for AendernSEPAMandatResult
