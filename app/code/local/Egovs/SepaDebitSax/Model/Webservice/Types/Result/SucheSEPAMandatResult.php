<?php
/**
 * File for class Egovs_SepaDebitSax_Model_Webservice_Types_Result_SucheSEPAMandatResult
 * @package SepaMv
 * @subpackage Structs
 * @date 2014-03-12
 ...
 */
/**
 * This class stands for Egovs_SepaDebitSax_Model_Webservice_Types_Result_SucheSEPAMandatResult originally named SucheSEPAMandatResult
 ...
 * @version 0.9.0.0
 */
class Egovs_SepaDebitSax_Model_Webservice_Types_Result_SucheSEPAMandatResult extends Egovs_SepaDebitSax_Model_Webservice_WsdlClass
{
    /**
     * The Result
    ...
    public $Verbleibende;
    /**
     * Constructor method for SucheSEPAMandatResult
