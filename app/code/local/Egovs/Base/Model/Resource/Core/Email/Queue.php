...
class Egovs_Base_Model_Resource_Core_Email_Queue extends Mage_Core_Model_Resource_Email_Queue
{
    /**
    ...
    public function wasEmailQueued(Mage_Core_Model_Email_Queue $queue)
    {
        ...
        if ($queue->hasAttachments()) {
            ...
            $select->join(
                array('attachments' => $this->getTable('egovsbase/mail_attachment')),
