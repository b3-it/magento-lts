...
/**
 * 
 *  Anzeige einer Liste von Einträgen
 *  @category Egovs
 ...
 */
class Egovs_Base_Block_Adminhtml_Widget_Form_Table extends Varien_Data_Form_Element_Abstract
{
    ...
    public function getHtml()
    {
    	...
    	$renderer->setTemplate('egovs/widget/form/table.phtml');
