 ...
 */
class Egovs_Base_Adminhtml_CustomerController extends Mage_Adminhtml_CustomerController
{
    /**
    ...
    public function saveAction()
    {
        ...
        if ($data) {
            ...
            if (Mage::getSingleton('admin/session')->isAllowed('customer/newsletter') && isset($data['subscription'])) {
            ...
            try {
                ...
                if ($customer->getId() > 0) {
                	...
                	$this->getResponse()->setRedirect($this->getUrl('*/customer/new'));
                }
                return;
            } catch (Exception $e) {
