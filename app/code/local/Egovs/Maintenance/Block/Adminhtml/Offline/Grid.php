 ...
 */
class Egovs_Maintenance_Block_Adminhtml_Offline_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	protected function _prepareColumns()
	{
		$this->addColumn('id', array(
				'header'    => Mage::helper('egovs_maintenance')->__('ID'),
				'align'     =>'right',
				'width'     => '50px',
				'index'     => 'id',
		));
		 ...
		 $this->addColumn('website', array(
		 		'header'    => Mage::helper('egovs_maintenance')->__('Website'),
		 		'align'     =>'left',
		 		'index'     => 'website',
		 		'width'     => '50px',
		 ));
		 ...
		 $this->addColumn('store', array(
		 		'header'    => Mage::helper('egovs_maintenance')->__('Store'),
		 		'align'     =>'left',
		 		'index'     => 'store',
		 		'width'     => '50px',
		 ));
		 ...
		 $this->addColumn('off_time', array(
		 		'header'    => Mage::helper('egovs_maintenance')->__('Off Time'),
		 		'align'     =>'left',
		 		'index'     => 'off_time',
		 		'width'     => '150px',
		 ));
		 ...
		 $this->addColumn('on_time', array(
		 		'header'    => Mage::helper('egovs_maintenance')->__('On Time'),
		 		'align'     =>'left',
		 		'index'     => 'on_time',
		 		'width'     => '150px',
		 ));
		 ...
		 $this->addColumn('dhours', array(
		 		'header'    => Mage::helper('egovs_maintenance')->__('Duration Hours'),
		 		'align'     =>'left',
		 		'index'     => 'dhours',
		 		'width'     => '150px',
		 ));
		 ...
		 $this->addColumn('duration', array(
		 		'header'    => Mage::helper('egovs_maintenance')->__('Duration Days'),
		 		'align'     =>'left',
		 		'index'     => 'duration',
		 		'width'     => '150px',
		 ));
