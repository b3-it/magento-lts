...
class Egovs_Acl_Block_Adminhtml_Catalog_Product_Attribute_Set_Main extends Mage_Adminhtml_Block_Catalog_Product_Attribute_Set_Main
{
    protected function _prepareLayout()
    {
    	$canDelete = Mage::getSingleton('admin/session')->isAllowed('admin/catalog/attributes/sets/attributesetdelete');
    	$canSave = Mage::getSingleton('admin/session')->isAllowed('admin/catalog/attributes/sets/attributesetsave');
