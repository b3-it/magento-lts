 ...
 */
class Egovs_Acl_Block_Adminhtml_Catalog_Product_Edit_Tabs extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tabs
{
    ...
    protected function _prepareLayout()
    {
    	...
    	if(!$canVisit) return Mage_Adminhtml_Block_Widget_Tabs::_prepareLayout();
    	
    
    	
    	$this->_parentPrepareLayout($product, $canStatus );
     ...
     private function _parentPrepareLayout($product, $canStatus)
    {
        ...
        if ($setId) {
            ...
            foreach ($groupCollection as $group) {
                ...
                foreach ($attributes as $key => $attribute) {
                    ...
                    if(!$canStatus)
                    {
                    	if($attribute->getName() == 'status') unset($attributes[$key]);
                    } 
                }
