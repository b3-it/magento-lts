...
class Egovs_Acl_Block_Adminhtml_Customer extends Mage_Adminhtml_Block_Customer
{

    public function __construct()
    {
    	$canAdd = Mage::getSingleton('admin/session')->isAllowed('admin/customer/manage/newcustomer');
