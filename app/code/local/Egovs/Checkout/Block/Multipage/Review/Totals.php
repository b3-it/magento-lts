...
class Egovs_Checkout_Block_Multipage_Review_Totals extends Mage_Checkout_Block_Cart_Abstract
{
	...
	*/
    ...
    protected function _getTotalRenderer($code)
    {
        if($code == 'tax')
        {
        	 $this->_totalRenderers[$code] = $this->getLayout()->createBlock('mpcheckout/multipage_total_tax', "{$code}_total_renderer");
        }
        else
        {
