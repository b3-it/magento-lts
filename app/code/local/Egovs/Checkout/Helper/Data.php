 ...
 */
class Egovs_Checkout_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    {
    	return $this->_getUrl('customer/account/forgotpassword',array('_secure'=>true));
    }
    
    public function getLoginUrl()
    {
    	return $this->_getUrl('customer/account/login',array('_secure'=>true));
    }
