<?php
/**
 * File for Egovs_Paymentbase_Model_Payplace_WsdlClass to communicate with SOAP service
 ...
 */
/**
 * Egovs_Paymentbase_Model_Payplace_WsdlClass to communicate with SOAP service
 * Documentation : Element group for pan-alias requests.
 * @package Egovs_Paymentbase
 * @date 16.10.2014
 * @author Frank Rochlitzer
 * @version 0.1.0.0
 */
class Egovs_Paymentbase_Model_Payplace_WsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'file://./app/code/local/Egovs/Paymentbase/etc/Callback.wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::setLastError()
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::initSoapClient()
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::initInternArrayToIterate()
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::_set()
     ...
     * @return Egovs_Paymentbase_Model_Payplace_WsdlClass
     */
     ...
     * @return Egovs_Paymentbase_Model_Payplace_WsdlClass|null
     */
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'Egovs_Paymentbase_Model_Payplace_WsdlClass'))
            {
     ...
     * @uses PayplaceClassMap::classMap()
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::getDefaultWsdlOptions()
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::getSoapClientClassName()
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('Egovs_Paymentbase_Model_Payplace_ClassMap', true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = Egovs_Paymentbase_Model_Payplace_ClassMap::classMap();
     ...
     * If a class is named as {Payplace}SoapClient, then this is the class that will be used.
    ...
    {
        if (class_exists('Egovs_Paymentbase_Model_Payplace_Soap_Client') && is_subclass_of('Egovs_Paymentbase_Model_Payplace_Soap_Client', 'SoapClient'))
            return 'Egovs_Paymentbase_Model_Payplace_Soap_Client';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::WSDL_CACHE_WSDL
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::WSDL_COMPRESSION
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::WSDL_ENCODING
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::WSDL_EXCEPTIONS
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::WSDL_FEATURES
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::WSDL_LOGIN
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::WSDL_PASSWORD
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::WSDL_SOAP_VERSION
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::WSDL_STREAM_CONTEXT
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::WSDL_TRACE
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::WSDL_TYPEMAP
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::WSDL_URL
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::VALUE_WSDL_URL
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::WSDL_USER_AGENT
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::WSDL_PROXY_HOST
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::WSDL_PROXY_PORT
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::WSDL_PROXY_LOGIN
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::WSDL_PROXY_PASSWORD
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::WSDL_LOCAL_CERT
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::WSDL_PASSPHRASE
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::WSDL_AUTHENTICATION
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::WSDL_SSL_METHOD
    ...
    public static function getDefaultWsdlOptions()
    {
        return array(
                    ...
                    self::WSDL_LOGIN=>self::_getLoginFromConfig(),
                    self::WSDL_PASSWORD=>self::_getPasswordFromConfig(),
    ...
    /**
     * Service URL aus Config lesen
     * 
     * @return string Location
     */
    protected static function _getLocationFromConfig() {
    	//FIXME :: unqualified Elements in WSDL needed!!!!
    	//$location = Mage::getConfig()->getModuleDir('etc', "Egovs_Paymentbase").DS.'payplace.xmlapi.xml';
    	$location = Mage::getStoreConfig('payment_services/payplace/service_url');
    ...
    /**
     * Account name für Login aus Config lesen
     * 
     * @return string
     */
    protected static function _getLoginFromConfig() {
    	$_encryptedAccountName = Mage::getStoreConfig('payment_services/payplace/account_name');
    	return Mage::helper('core')->decrypt($_encryptedAccountName);
    }
    
    /**
     * Account Passwort für Login aus Config lesen
     *
     * @return string
     */
     ...
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::getSoapClient()
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::getFormatedXml()
     ...
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::getSoapClient()
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::convertStringHeadersToArray()
     ...
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::count()
     * @return int
     */
     ...
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::getInternArrayToIterate()
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::getInternArrayToIterateOffset()
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::getInternArrayToIterateOffset()
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see Egovs_Paymentbase_Model_Payplace_WsdlClass::offsetGet()
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::getAttributeName()
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::__toString()
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::_set()
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::_get()
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::setInternArrayToIterate()
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::setInternArrayToIterateIsArray()
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::item()
     * @return mixed
     */
     ...
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::item()
     * @uses Egovs_Paymentbase_Model_Payplace_WsdlClass::length()
     * @return mixed
     */
