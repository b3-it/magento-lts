<?php
/**
 * Redirectblock für Giropay/Kreditkarte über Payplace
 *
 * Redirect zu Payplace
 *
 * @category   	Egovs
 * @package    	Egovs_Paymentbase
 * @name       	Egovs_Paymentbase_Block_Payplace_Redirect
 * @author 		Frank Rochlitzer <f.rochlitzer@b3-it.de>
 * @copyright  	Copyright (c) 2014 B3 IT Systeme GmbH - http://www.b3-it.de
 * @license		http://sid.sachsen.de OpenSource@SID.SACHSEN.DE
 */
class Egovs_Paymentbase_Block_Payplace_Redirect extends Mage_Core_Block_Abstract
{
...
<head>
<title> '.$this->_preTitle.' - Payplace </title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="description" content="Meta Description" />
<meta name="keywords" content="giropay, kreditkarte, payplace" />
...
<div class="wrapper">
	...
	<div class="header">
		...
		$html .= $this->__ ( 'You will be redirected to Payplace in a few seconds. If not, click next.' );
		$html .= '<br />';
