 ...
 */
class Egovs_Extreport_Model_Mysql4_Report_Collection extends Mage_Reports_Model_Mysql4_Report_Collection
{
	/**
    ...
    {
        return array(
            'asc'=>Mage::helper('extreport')->__('Ascending'),
            'desc'=>Mage::helper('extreport')->__('Descending')
        );
    }    
