<?php
/**
 * ResourceModel Collection für Produkte
 *
 * @category   	Egovs
 ...
 */
class Egovs_Extreport_Model_Mysql4_Product_Collection extends Mage_Catalog_Model_Resource_Eav_Mysql4_Product_Collection
{
    ...
    /**
     * Fügt zusätzliche Felder zum SQL Select hinzu
     * 
     * @return void
     */
    ...
    /**
     * Liefert die SQL Query zur ermittlung der Ergbnisanzahl
     * 
     * @return string
     * 
     * @see Mage_Catalog_Model_Resource_Eav_Mysql4_Product_Collection::getSelectCountSql()
     */
    ...
    public function addShippedQty($from = '', $to = '')
    {
        $qtyShippedTableName = $this->getTable('sales/order_item');
        $qtyShippedFieldName = 'qty_shipped';
        ...
        $this->getSelect()->reset()->from(
            array('order_items' => $qtyShippedTableName),
            array('shipped_qty' => "SUM(order_items.{$qtyShippedFieldName})"))
        ;
     ...
     * 
     * @return Egovs_Extreport_Model_Mysql4_Product_Collection
     * 
     * @see Mage_Eav_Model_Entity_Collection_Abstract::setOrder()
     */
