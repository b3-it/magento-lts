<?php
/**
 * ResourceModel Collection für Steuern
 *
 * @category   	Egovs
 ...
 */
class Egovs_Extreport_Model_Mysql4_Sales_Tax_Collection extends Mage_Reports_Model_Mysql4_Tax_Collection
{
	/**
	 ...
	 *
	 * @return Egovs_Extreport_Model_Mysql4_Sales_Tax_Collection
	 */
