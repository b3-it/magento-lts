...
class Slpb_Extstock_Block_Adminhtml_Stock_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_updateButton('save', 'label', Mage::helper('extstock')->__('Save Stock'));
        $this->_updateButton('delete', 'label', Mage::helper('extstock')->__('Delete Stock'));
...
*/
    ...
    {
       return Mage::helper('extstock')->__("Edit Stock");//. " " . $this->htmlEscape(Mage::registry('extstock_data')->getDistributor());
