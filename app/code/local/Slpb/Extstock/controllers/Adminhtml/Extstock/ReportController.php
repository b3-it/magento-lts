 ...
 */
class Slpb_Extstock_Adminhtml_Extstock_ReportController extends Egovs_Extreport_Controller_Abstract
{
    ...
    protected function _isAllowed() {
    	...
    	switch ($action) {
    		default:
    			return Mage::getSingleton('admin/session')->isAllowed('report/extstockroot/inwards');
    			break;
    	}
    }
