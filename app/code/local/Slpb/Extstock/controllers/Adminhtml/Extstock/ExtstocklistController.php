...
class Slpb_Extstock_Adminhtml_Extstock_ExtstocklistController extends Mage_Adminhtml_Controller_action
{
	...
	public function editAction() {
		...
		if ($product_id) {
			...
			$this->_redirect('adminhtml/extstock_extstock/', array('product_id' => $product_id, 'distributor' => $distributor));
		} else {
