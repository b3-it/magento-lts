 ...
 */
class Slpb_Verteiler_Block_Adminhtml_Order_Create_Product_Renderer_Useit extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Action
{
    public function render(Varien_Object $row)
    {
    	...
    	if($row->getMissingItems() == null)
    	{
	        $this->getColumn()->setActions(array(array(    
	        	...
	        	'caption' => Mage::helper('verteiler')->__('Add To Order'),
	        )));
