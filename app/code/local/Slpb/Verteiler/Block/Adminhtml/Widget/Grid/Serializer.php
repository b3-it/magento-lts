 ...
 */
class Slpb_Verteiler_Block_Adminhtml_Widget_Grid_Serializer extends Mage_Core_Block_Template
{
    ...
    {
        parent::_construct();
        $this->setTemplate('slpb/verteiler/serializer.phtml');
        return $this;
    }
    ...
    {
        if ($asJSON) {
            return Mage::helper('verteiler')->jsonEncode($this->_inputsToSerialize);
        }
    ...
    public function getDataAsJSON()
    {
        ...
        return Mage::helper('verteiler')->jsonEncode($result);
    }
