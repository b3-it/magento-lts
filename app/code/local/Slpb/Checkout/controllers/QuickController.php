 ...
 */
class Slpb_Checkout_QuickController extends Mage_Core_Controller_Front_Action//Mage_Checkout_CartController
{
    ...
    public function addAction()
    {
        ...
        $adr->setCollectShippingRates(false)
    ...
    {
        $this->getResponse()->setBody($this->getLayout()->createBlock('slpbcheckout/quick_suggest')->toHtml());
    }
