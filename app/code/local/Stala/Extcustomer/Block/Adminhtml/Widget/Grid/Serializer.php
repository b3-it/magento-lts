 ...
 */
class Stala_Extcustomer_Block_Adminhtml_Widget_Grid_Serializer extends Mage_Core_Block_Template
{
    ...
    {
        parent::_construct();
        $this->setTemplate('stala/extcustomer/edit/serializer.phtml');
        return $this;
    }
    ...
    {
        if ($asJSON) {
            return Mage::helper('extcustomer')->jsonEncode($this->_inputsToSerialize);
        }
    ...
    public function getDataAsJSON()
    {
        ...
        return Mage::helper('extcustomer')->jsonEncode($result);
    }
