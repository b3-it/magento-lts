 ...
 */
class Stala_CustomerReports_Model_Resource_Sales_Invoiced extends Mage_Sales_Model_Resource_Report_Invoiced
{
    ...
    protected function _aggregateByInvoiceCreatedAt($from, $to)
    {
        ...
        try {
            ...
            $columns = array(
            	...
            	'customer_group_id'		=> 'order_table.customer_group_id',
