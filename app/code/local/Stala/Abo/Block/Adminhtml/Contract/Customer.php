...
class Stala_Abo_Block_Adminhtml_Contract_Customer extends Mage_Adminhtml_Block_Widget_Grid_Container
{
  ...
  public function __construct()
  {
    ...
    {
        return Mage::helper('stalaabo')->__('Please select a customer');
    }
