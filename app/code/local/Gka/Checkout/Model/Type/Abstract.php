 ...
 */
abstract class Gka_Checkout_Model_Type_Abstract extends Mage_Checkout_Model_Type_Abstract
{
	...
	public function getShippingMethod() {
		if ($this->_shippingmethod == null) {
			$this->_shippingmethod = Mage::getStoreConfig('gka_checkout/invoice/invoice_shippingmethod');
