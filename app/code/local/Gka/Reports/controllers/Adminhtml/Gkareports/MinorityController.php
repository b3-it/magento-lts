 ...
 */ 
class Gka_Reports_Adminhtml_Gkareports_MinorityController extends Mage_Adminhtml_Controller_action
{
	...
	protected function _initAction() {
		$this->loadLayout()
            ...
            ;
        $this->_title(Mage::helper('adminhtml')->__('Minority Interest'));
    ...
    public function gridAction()
    {
        ...
        $this->getResponse()->setBody(
            $this->getLayout()->createBlock('gka_reports/adminhtml_minority_grid')->toHtml()
        );
    }
    ...
    {
        $fileName   = $this->__('Minority Interest');
