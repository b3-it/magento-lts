 ...
 * 
 */
class Sid_Report_Model_Mysql4_Sales_Quantity_Collection extends Mage_Sales_Model_Mysql4_Order_Item_Collection
{
	 ...
	 */
 	 ...
 	 * 
 	 * @return Sid_Report_Model_Mysql4_Sales_Quantity_Collection
 	 */
     ...
     */
   	protected function _getCategoryNames($ids) {   		
   		return Mage::helper('sidreport')->getCategoryNames($ids);
   	}
   	...
   	public function getCategorysAsOptionArray()	{
   		return Mage::helper('sidreport')->getCategorysAsOptionArray();
   	}
}