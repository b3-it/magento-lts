 ...
 */
class Sid_ExportOrder_Model_Format_Opentrans_OrderSummary_TotalAmount extends Sid_ExportOrder_Model_Format_Opentrans_Abstract
{
	
	protected $_Tag = "TOTAL_AMOUNT";
