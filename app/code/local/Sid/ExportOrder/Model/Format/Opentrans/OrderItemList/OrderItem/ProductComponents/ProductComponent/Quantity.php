 ...
 */
class Sid_ExportOrder_Model_Format_Opentrans_OrderItemList_OrderItem_ProductComponents_ProductComponent_Quantity extends Sid_ExportOrder_Model_Format_Opentrans_Abstract
{
	
	protected $_Tag = "QUANTITY";
