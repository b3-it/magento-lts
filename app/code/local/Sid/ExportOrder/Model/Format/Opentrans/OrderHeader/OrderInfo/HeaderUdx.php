 ...
 */
class Sid_ExportOrder_Model_Format_Opentrans_OrderHeader_OrderInfo_HeaderUdx extends Sid_ExportOrder_Model_Format_Opentrans_Abstract
{
	
	protected $_Tag = "HEADER_UDX";
