 ...
 */
class Sid_ExportOrder_Model_Format_Opentrans_OrderHeader_OrderInfo_Payment_Card_CardNum extends Sid_ExportOrder_Model_Format_Opentrans_Abstract
{
	
	protected $_Tag = "CARD_NUM";
