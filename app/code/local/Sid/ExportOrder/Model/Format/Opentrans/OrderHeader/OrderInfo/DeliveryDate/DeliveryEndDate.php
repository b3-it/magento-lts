 ...
 */
class Sid_ExportOrder_Model_Format_Opentrans_OrderHeader_OrderInfo_DeliveryDate_DeliveryEndDate extends Sid_ExportOrder_Model_Format_Opentrans_Abstract
{
	
	protected $_Tag = "DELIVERY_END_DATE";
