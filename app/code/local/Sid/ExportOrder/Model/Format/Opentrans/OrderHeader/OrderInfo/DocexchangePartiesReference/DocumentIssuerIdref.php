 ...
 */
class Sid_ExportOrder_Model_Format_Opentrans_OrderHeader_OrderInfo_DocexchangePartiesReference_DocumentIssuerIdref extends Sid_ExportOrder_Model_Format_Opentrans_Abstract
{
	
	protected $_Tag = "DOCUMENT_ISSUER_IDREF";
