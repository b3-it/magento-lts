 ...
 */
class Sid_ExportOrder_Model_Format_Opentrans_OrderItemList_OrderItem_ProductFeatures_Feature_FvalueType extends Sid_ExportOrder_Model_Format_Opentrans_Abstract
{
	
	protected $_Tag = "bmecat:FVALUE_TYPE";
