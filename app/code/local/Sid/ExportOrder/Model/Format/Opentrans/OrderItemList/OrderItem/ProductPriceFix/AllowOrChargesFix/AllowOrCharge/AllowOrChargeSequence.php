 ...
 */
class Sid_ExportOrder_Model_Format_Opentrans_OrderItemList_OrderItem_ProductPriceFix_AllowOrChargesFix_AllowOrCharge_AllowOrChargeSequence extends Sid_ExportOrder_Model_Format_Opentrans_Abstract
{
	
	protected $_Tag = "ALLOW_OR_CHARGE_SEQUENCE";
