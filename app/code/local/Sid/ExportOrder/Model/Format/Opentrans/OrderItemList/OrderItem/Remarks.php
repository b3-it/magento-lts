 ...
 */
class Sid_ExportOrder_Model_Format_Opentrans_OrderItemList_OrderItem_Remarks extends Sid_ExportOrder_Model_Format_Opentrans_Abstract
{
	
	protected $_Tag = "REMARKS";
