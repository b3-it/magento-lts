 ...
 */
class Sid_ExportOrder_Model_Format_Opentrans_OrderItemList_OrderItem_ProductId_DescriptionLong extends Sid_ExportOrder_Model_Format_Opentrans_Abstract
{
	
	protected $_Tag = "bmecat:DESCRIPTION_LONG";
