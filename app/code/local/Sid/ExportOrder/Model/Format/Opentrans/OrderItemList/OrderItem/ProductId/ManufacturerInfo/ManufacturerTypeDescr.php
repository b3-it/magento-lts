 ...
 */
class Sid_ExportOrder_Model_Format_Opentrans_OrderItemList_OrderItem_ProductId_ManufacturerInfo_ManufacturerTypeDescr extends Sid_ExportOrder_Model_Format_Opentrans_Abstract
{
	
	protected $_Tag = "bmecat:MANUFACTURER_TYPE_DESCR";
