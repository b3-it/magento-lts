 ...
 */
class Sid_ExportOrder_Model_Format_Opentrans_OrderHeader_SourcingInfo_Agreement_MimeInfo_Mime_FileHashValue extends Sid_ExportOrder_Model_Format_Opentrans_Abstract
{
	
	protected $_Tag = "FILE_HASH_VALUE";
