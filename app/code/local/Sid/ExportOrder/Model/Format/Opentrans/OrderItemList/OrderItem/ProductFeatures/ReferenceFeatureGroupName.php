 ...
 */
class Sid_ExportOrder_Model_Format_Opentrans_OrderItemList_OrderItem_ProductFeatures_ReferenceFeatureGroupName extends Sid_ExportOrder_Model_Format_Opentrans_Abstract
{
	
	protected $_Tag = "bmecat:REFERENCE_FEATURE_GROUP_NAME";
