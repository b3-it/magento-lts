 ...
 */
class Sid_ExportOrder_Model_Format_Opentrans_OrderSummary_TotalItemNum extends Sid_ExportOrder_Model_Format_Opentrans_Abstract
{
	
	protected $_Tag = "TOTAL_ITEM_NUM";
