 ...
 */
class Sid_ExportOrder_Model_Format_Opentrans_OrderHeader_OrderInfo_TermsAndConditions extends Sid_ExportOrder_Model_Format_Opentrans_Abstract
{
	
	protected $_Tag = "TERMS_AND_CONDITIONS";
