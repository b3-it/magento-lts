 ...
 */
class Sid_ExportOrder_Model_Format_Opentrans_OrderHeader_OrderInfo_OrderPartiesReference_ShipmentPartiesReference_FinalDeliveryIdref extends Sid_ExportOrder_Model_Format_Opentrans_Abstract
{
	
	protected $_Tag = "FINAL_DELIVERY_IDREF";
