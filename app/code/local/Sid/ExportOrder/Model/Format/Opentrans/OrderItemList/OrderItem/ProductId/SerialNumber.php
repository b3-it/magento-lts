 ...
 */
class Sid_ExportOrder_Model_Format_Opentrans_OrderItemList_OrderItem_ProductId_SerialNumber extends Sid_ExportOrder_Model_Format_Opentrans_Abstract
{
	
	protected $_Tag = "SERIAL_NUMBER";
