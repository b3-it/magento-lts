 ...
 */
class Sid_ExportOrder_Model_Format_Opentrans_OrderHeader_SourcingInfo_Agreement_AgreementDescr extends Sid_ExportOrder_Model_Format_Opentrans_Abstract
{
	
	protected $_Tag = "AGREEMENT_DESCR";
