 ...
 */
class Sid_ExportOrder_Model_Format_Opentrans_OrderHeader_SourcingInfo_Agreement_MimeInfo_Mime_MimePurpose extends Sid_ExportOrder_Model_Format_Opentrans_Abstract
{
	
	protected $_Tag = "MIME_PURPOSE";
