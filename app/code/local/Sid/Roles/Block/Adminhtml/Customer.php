...
class Sid_Roles_Block_Adminhtml_Customer extends Mage_Adminhtml_Block_Customer
{

    public function __construct()
    {
    	$acl = Mage::getSingleton('acl/productacl');
    	$canAdd = $acl->testPermission('admin/customer/sid_manage_customer/newcustomer');

    	$this->_blockGroup = 'sidroles';
