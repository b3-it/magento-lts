...
class Sid_Framecontract_Helper_Groupscatalog extends Mage_Core_Helper_Abstract
{
	/**
	 ...
	 * @var string
	 */
	protected $_attributeCode = 'groupscatalog2_groups';
	 ...
	 */
	public function addGroupsFilterToProductCollection(Mage_Catalog_Model_Resource_Product_Collection $collection, $customerGroupId = null)
	{
