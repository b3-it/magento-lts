 ...
 */
class Sid_Framecontract_Block_Adminhtml_Import_Edit_Uploader extends Mage_Adminhtml_Block_Widget
{
    /**
    ...
    {
        parent::__construct();
        $this->setTemplate('sid/framecontract/import/uploader.phtml');
    }
    ...
    protected function _prepareLayout()
    {
        ...
        $this->getUploader()->getUploaderConfig()
            ...
            ->setTarget(Mage::getModel('adminhtml/url')->addSessionParam()->getUrl('adminhtml/framecontract_import/upload'));
