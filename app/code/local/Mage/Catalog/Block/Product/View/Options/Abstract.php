...
abstract class Mage_Catalog_Block_Product_View_Options_Abstract extends Mage_Core_Block_Template
{
    ...
    protected function _formatPrice($value, $flag=true)
    {
        ...
        $priceStr = $this->_getAdditionalPriceInfo($priceStr, $flag);
    ...
    protected function _getAdditionalPriceInfo($html, $includeContainer = true) {
