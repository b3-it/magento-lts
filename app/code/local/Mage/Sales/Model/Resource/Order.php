...
class Mage_Sales_Model_Resource_Order extends Mage_Sales_Model_Resource_Order_Abstract
{
    ...
    protected function _initVirtualGridColumns()
    {
        ...
        $ifnullFirst   = $adapter->getIfNullSql($adapter->getConcatSql(array('{{table}}.firstname', $adapter->quote(' '))), $adapter->quote(''));
        $ifnullMiddle  = $adapter->getIfNullSql($adapter->getConcatSql(array('{{table}}.middlename', $adapter->quote(' '))), $adapter->quote(''));
