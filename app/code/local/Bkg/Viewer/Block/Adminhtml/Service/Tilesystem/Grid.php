<?php
  ...
  */
class Bkg_Viewer_Block_Adminhtml_Service_Tilesystem_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  {
      $collection = Mage::getModel('bkgviewer/service_tilesystem')->getCollection();
