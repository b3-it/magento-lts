<?php
  ...
  */
class Bkg_Viewer_Block_Adminhtml_Service_Tilesystem_Edit_Tab_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  {
      $collection = Mage::getModel('bkgviewer/service_tile')->getCollection();
      $collection->getSelect()->where('system_id=?',Mage::registry('tilesystem_data')->getId());
