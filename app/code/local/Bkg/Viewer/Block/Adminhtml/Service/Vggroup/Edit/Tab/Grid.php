<?php
  ...
  */
class Bkg_Viewer_Block_Adminhtml_Service_Vggroup_Edit_Tab_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  {
      $collection = Mage::getModel('bkgviewer/service_vg')->getCollection();
      $collection->getSelect()->where('group_id=?',Mage::registry('tilesystem_data')->getId());
