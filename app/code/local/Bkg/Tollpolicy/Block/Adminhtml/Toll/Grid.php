<?php
  ...
  */
class Bkg_Tollpolicy_Block_Adminhtml_Toll_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('toll_entityGrid');
      $this->setDefaultSort('toll_entity_id');
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('date_to', array(
          'header'    => Mage::helper('bkg_tollpolicy')->__('To'),
          //'align'     =>'left',
          //'width'     => '150px',
          'index'     => 'date_to',
      ));
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('toll_entity_ids');
