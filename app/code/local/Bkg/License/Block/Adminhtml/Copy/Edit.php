 ...
 * @package    	Bkg_License
 * @name       	Bkg_License_Block_Adminhtml_Copy_Entity_Edit
...
class Bkg_License_Block_Adminhtml_Copy_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    {
        if( Mage::registry('copyentity_data') && Mage::registry('copyentity_data')->getId() ) {
            return Mage::helper('bkg_license')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('copyentity_data')->getId()));
        } else {
