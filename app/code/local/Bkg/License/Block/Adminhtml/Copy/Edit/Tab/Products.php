 ...
 */
class Bkg_License_Block_Adminhtml_Copy_Edit_Tab_Products extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        $form = new Varien_Data_Form();
        $this->setForm($form);
        $fieldset = $form->addFieldset('copyagreement_form', array('legend'=>Mage::helper('bkg_license')->__('Products')));
        ...
        $collection = Mage::getModel('bkg_license/copy_products')->getCollection();
