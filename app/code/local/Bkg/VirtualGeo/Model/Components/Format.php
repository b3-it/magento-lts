 ...
 */
class Bkg_Virtualgeo_Model_Components_Format extends Bkg_Virtualgeo_Model_Components_Component
{
	//alias der Tabelle für die Verbindung zum Produkt
	protected $_productRelationTable = 'virtualgeo/components_format_product';
	
	//name der Spalte des Fremdschlüssels in der Produkttabelle
	protected $_productRelationField = 'format_id';
