 ...
 */
class Bkg_Virtualgeo_Model_Components_Storageproduct extends Mage_Core_Model_Abstract
{
    ...
    /**
     * Alle Storagee die für dieses Produkt und Store verfügbar sind ermittel
     * @param int $productId
     * @param int $storeId
     * @return array| NULL[]
     */
