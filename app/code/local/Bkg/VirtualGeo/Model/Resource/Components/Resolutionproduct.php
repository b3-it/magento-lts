<?php
  ...
  */
class Bkg_Virtualgeo_Model_Resource_Components_Resolutionproduct extends Mage_Core_Model_Resource_Db_Abstract
{
    ...
    public function saveDefault($defaultId, $productId, $storeId)
    {
    	...
    	$data['is_default'] = '1';
    	if($defaultId){
    		$this->_getWriteAdapter()->update($table, $data, "product_id= $productId  AND store_id = $storeId AND resolution_id = $defaultId ");
    	}
