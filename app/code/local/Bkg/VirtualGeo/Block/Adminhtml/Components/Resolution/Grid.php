<?php
  ...
  */
class Bkg_VirtualGeo_Block_Adminhtml_Components_Resolution_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('components_resolution_entityGrid');
      $this->setDefaultSort('components_resolution_entity_id');
  ...
  {
      $collection = Mage::getModel('virtualgeo/components_resolution')->getCollection();
  ...
  protected function _prepareColumns()
  {
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('componentsresolution_entity_ids');
