<?php
  ...
  */
class Bkg_VirtualGeo_Block_Adminhtml_Components_Structure_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('components_structure_entityGrid');
      $this->setDefaultSort('components_structure_entity_id');
  ...
  protected function _prepareColumns()
  {
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('componentsstructure_entity_ids');
