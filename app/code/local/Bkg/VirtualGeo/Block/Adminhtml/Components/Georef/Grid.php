...
class Bkg_VirtualGeo_Block_Adminhtml_Components_Georef_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  {
      parent::__construct();
      $this->setId('components_georef_entityGrid');
      $this->setDefaultSort('components_georef_entity_id');
  ...
  {
      $collection = Mage::getModel('virtualgeo/components_georef')->getCollection();
  ...
  protected function _prepareColumns()
  {
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('componentsgeoref_entity_ids');
