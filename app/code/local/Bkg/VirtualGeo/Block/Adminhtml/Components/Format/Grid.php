<?php
  ...
  * @name       	Bkg_VirtualGeo_Block_Adminhtml_Components_Formatentity_Grid
  * @author 		Holger Kögel <h.koegel@b3-it.de>
  * @copyright  	Copyright (c) 2017 B3 It Systeme GmbH - http://www.b3-it.de
  * @license		http://sid.sachsen.de OpenSource@SID.SACHSEN.DE
  */
class Bkg_VirtualGeo_Block_Adminhtml_Components_Format_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  {
      $collection = Mage::getModel('virtualgeo/components_format')->getCollection();
