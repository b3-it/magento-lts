...
class Bkg_VirtualGeo_Block_Adminhtml_Components_Format_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    {
        if( Mage::registry('componentsformat_entity_data') && Mage::registry('componentsformat_entity_data')->getId() ) {
            return Mage::helper('virtualgeo')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('componentsformat_entity_data')->getId()));
        } else {
