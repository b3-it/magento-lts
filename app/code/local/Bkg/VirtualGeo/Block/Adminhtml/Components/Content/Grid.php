<?php
  ...
  */
class Bkg_VirtualGeo_Block_Adminhtml_Components_Content_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('componentsContent_entity_ids');
