<?php
  ...
  */
class Bkg_VirtualGeo_Block_Adminhtml_Components_Accounting_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('components_accounting_entityGrid');
      $this->setDefaultSort('components_accounting_entity_id');
  ...
  {
      $collection = Mage::getModel('virtualgeo/components_accounting')->getCollection();
  ...
  protected function _prepareColumns()
  {
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('componentsaccounting_entity_ids');
