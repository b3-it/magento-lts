...
class Bkg_VirtualGeo_Block_Adminhtml_Catalog_Product_Edit_Tab_Content_Selectiontools extends Mage_Adminhtml_Block_Widget
{
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('bkg/virtualgeo/product/edit/tab/content/selectiontools.phtml');
