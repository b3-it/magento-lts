...
class Dwd_Periode_Block_Adminhtml_Catalog_Product_Edit_Tab_Periode_Price_Tier
    ...
    implements Varien_Data_Form_Element_Renderer_Interface
{
    ...
    {
        $this->setTemplate('dwd/periode/catalog/product/tab/periode/price/tier.phtml');
    }
    ...
    protected function _prepareLayout()
    {
        $button = $this->getLayout()->createBlock('adminhtml/widget_button')
            ->setData(array(
                ...
                'onclick'   => 'return AboTierPriceControl.addItem()',
                'class'     => 'add'
            ));
