...
class Dwd_Abo_Helper_Data extends Mage_Core_Helper_Abstract
{
	...
	public function sendEmail($EmailAddress, $customer, $data, $template)
	{
		try
		{
			...
			$sender = array();
			$sender['name'] = Mage::getStoreConfig("dwd_abo/email/abo_email_sender", $storeid);
			$sender['email'] = Mage::getStoreConfig("dwd_abo/email/abo_email_address", $storeid);
