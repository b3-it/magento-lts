 ...
 */
class Dwd_Abomigration_Model_Import extends Mage_ImportExport_Model_Abstract
{
    /**
    ...
    protected function _getEntityAdapter()
    {
        if (!$this->_entityAdapter) {
            $this->_entityAdapter = Mage::getModel('abomigration/import_entity_abo');
    ...
    {
    	return new Dwd_Abomigration_Model_Import_Adapter_Csv($sourceFile);
    }
    ...
    public function importSource()
    {
        ...
        $this->deleteImageSource();
        return $result;
    }
    
    
    private function deleteImageSource()
    {
    	$dir = $this->_getEntityAdapter()->ImageSrcDir;
    ...
    {
    	return (boolean)(count($this->_entityAdapter->missingImages) > 0);
    }
    
    public function getMissingImages()
    {
    	return implode("<br/>", $this->_entityAdapter->missingImages);
    }
