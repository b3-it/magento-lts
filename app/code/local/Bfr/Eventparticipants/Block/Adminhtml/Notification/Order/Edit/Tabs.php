...
class Bfr_Eventparticipants_Block_Adminhtml_Notification_Order_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
  ...
  public function __construct()
  {
      ...
      $this->setTitle(Mage::helper('bfr_eventparticipants')->__('Notification Order Information'));
  }

  protected function _beforeToHtml()
  {
      $this->addTab('form_section', array(
          'label'     => Mage::helper('bfr_eventparticipants')->__('Notification Order Information'),
          'title'     => Mage::helper('bfr_eventparticipants')->__('Notification Order Information'),
