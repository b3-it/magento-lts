...
class TuChemnitz_Voucher_Block_Adminhtml_Sales_Items_Column_Name extends Mage_Adminhtml_Block_Sales_Items_Column_Name
{
	...
	public function getOrderOptions()
	{
		...
		if(count($collection->getItems()) > 0)
		{
			...
			$result[] = array('label' => 'Tans','value'=>implode('<br/>', $tans));
		}
