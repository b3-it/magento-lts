<?php
  ...
  * @package    	b3it_mq
  * @name       	B3it_Messagequeue_Block_Adminhtml_Email_Recipient_Grid
  * @author 		Holger Kögel <h.koegel@b3-it.de>
  * @copyright  	Copyright (c) 2017 B3 It Systeme GmbH - http://www.b3-it.de
  * @license		http://sid.sachsen.de OpenSource@SID.SACHSEN.DE
  */
class B3it_Messagequeue_Block_Adminhtml_Email_Recipient_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('email_recipientGrid');
      $this->setDefaultSort('email_recipient_id');
  ...
  protected function _prepareColumns()
  {
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('emailrecipient_ids');
